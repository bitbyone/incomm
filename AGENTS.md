# Incomm - Internals & Agent Specifications

This document describes the internal architecture of `incomm` and serves as the single source of truth for the JSON data schema and anchoring algorithm. It is intended for contributors, integrations developers, and AI agents interacting with the repository.
...
./gradlew :plugin:buildPlugin    # distributable ZIP -> plugins/intellij/build/distributions/
